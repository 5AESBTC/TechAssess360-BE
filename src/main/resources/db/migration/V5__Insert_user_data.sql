INSERT INTO users (create_at, name, email, phone_number, dob, gender, username, password, is_active, is_deleted, rank_id) VALUES
    ...
    (NOW(), 'Dao Van D', 'daovand@example.com', '0987654321', '1990-01-01', 'MALE', 'daovand', 'password123', 1, 0, 4),
    (NOW(), 'Dinh Thi E', 'dinhthie@example.com', '0976543210', '1992-05-15', 'FEMALE', 'dinhthie', 'password456', 1, 0, 4),
    (NOW(), 'Ly Van F', 'lyvanf@example.com', '0965432109', '1988-09-30', 'MALE', 'lyvanf', 'password789', 1, 0, 5);
